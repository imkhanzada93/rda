                    ...
                    <div class="col-sm-6">
                        <h1>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('plan-create')): ?>
                                <a href="<?php echo e(route('plans.create')); ?>" class="btn btn-sm btn-outline-primary btn-rounded"> <i class="fa fa-plus"></i> Plan</a>
                            <?php endif; ?>
                        </h1>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bookvxos/public_htmll/fmd.bookmyhouse.net/resources/views/plans/index.blade.php ENDPATH**/ ?>