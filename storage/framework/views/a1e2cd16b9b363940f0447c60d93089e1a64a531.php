            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3><?php echo e($insurance_type_count); ?></h3>
                            <p>Insurance Types</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-bag"></i>
                        </div>
                        <a href="<?php echo e(route('insurance-types.index')); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
...
<script>
    ...
    var donutData        = {
        labels: <?php echo json_encode($insurance_types); ?>,
        datasets: [
            {
                data: <?php echo json_encode($account_by_insurance_types); ?>,
                backgroundColor : <?php echo json_encode($insurance_types_color); ?>,
            }
        ]
    }
    var donutOptions     = {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rda\resources\views/home.blade.php ENDPATH**/ ?>