         ...
         <div class="tbsc">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
               <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Step 1 <i class="ri-arrow-right-s-line"></i></button>
               </li>
               <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Step 2 <i class="ri-arrow-right-s-line"></i></button>
               </li>
               <li class="nav-item" role="presentation">
                  ...
                  <div class="col-lg-12">
                     <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                           <div class="tb-hd">
                              <h3>Lets begin your journey towards better health coverage.<br/>
                                 Please select your bank below:
                              </h3>
                              <div class="br-line"></div>
                           </div>
                           <div class="row justify-content-center">
                              <?php $__currentLoopData = get_list('banks'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="col-md-2">
                                 <div class="button-bx">
                                    <input type="radio" class="btn-check" id="btncheckB<?php echo e($key); ?>" name="bank" value="<?php echo e($bank->id); ?>" autocomplete="off" <?php if($key == 0): ?> checked <?php endif; ?>>
                                    <label class="btn btn-cstm" for="btncheckB<?php echo e($key); ?>">
                                    <img src="<?php echo e(asset('storage/'.$bank->image)); ?>">
                                    </label>
                                 </div>
                              </div>
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                           <div class="tb-hd">
                              <h3>Please select your preferred insurance partner:</h3>
                              <div class="br-line"></div>
                           </div>
                           <div class="row justify-content-center">
...
</html><?php /**PATH /home/bookvxos/public_htmll/fmd.bookmyhouse.net/resources/views/accounts/form.blade.php ENDPATH**/ ?>