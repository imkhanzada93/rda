...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['insurance-type-list'])): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('insurance-types.index')); ?>" class="nav-link">
                        <i class="nav-icon fas fa-th"></i>
                        <p>Insurance Type</p>
                    </a>
                </li>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\laragon\www\rda\resources\views/layouts/menu.blade.php ENDPATH**/ ?>