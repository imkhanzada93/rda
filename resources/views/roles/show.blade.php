                            ...
                            <div class="card-body">
                                <div class="grid-striped">
                                        ...
                                        <div class="col-sm-10">
                                            @if(!empty($rolePermissions))
                                                @foreach($rolePermissions as $v)
                                                    <label class="label label-success">{{ ucfirst(str_replace('-', ' ', $v->name)) }},</label>
                                                @endforeach
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row font-weight-bold py-2">
                                        ...
                                        <div class="col-sm-10">{{ $role->created_at }}</div>
                                    </div>
                                    <div class="row font-weight-bold py-2">
                                        <div class="col-sm-2">Updated At: </div>
                                        <div class="col-sm-10">{{ $role->updated_at }}</div>
                                    </div>
                                    <div class="row font-weight-bold py-2">
                                        <div class="col-sm-2">Deleted At: </div>
                                        <div class="col-sm-10">{{ $role->deleted_at }}</div>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
